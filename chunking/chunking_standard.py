...
# 1. JSON 파일 목록
# ===========================
json_files = ["/home/alpaco/kimcy/Office_AI_Agent_System/parsing/parsed_standard.json"]
...
# 8. 청크 저장
# ===========================
with open("rag_chunks_standard.json", "w", encoding="utf-8") as f:
    json.dump(all_chunks, f, ensure_ascii=False, indent=2)

print("RAG용 청크를 'rag_chunks_standard.json'로 저장 완료")
